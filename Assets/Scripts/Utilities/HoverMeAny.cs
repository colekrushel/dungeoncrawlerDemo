...
public class HoverMeAny : MonoBehaviour
{
    //hover params
    ...
    [SerializeField] float xMult;
    [SerializeField] float yMult;
    [SerializeField] float zMult;
    ...
    void Update()
    {
        if (gameObject.activeSelf)
        {
            ...
            distanceMoved += d;
            gameObject.transform.localPosition += new Vector3(d*xMult, d*yMult, d*zMult);
